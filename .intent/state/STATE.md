...
- Candidate 7 practices protocol 0.2's provisional source-region ownership format on all logical Harness interventions. It excludes shared generated catalogs from the static patch, records source-to-generated mapping in the lifecycle receipt, and regenerates those catalogs after install or owned uninstall. This is lifecycle design evidence, not adoption or a live deployment claim.
