...
Status: draft embedded intent package with one selected C5 candidate realization. Retained C1 through C4 locks are historical implementation, installation and lifecycle evidence, not current acceptance.
