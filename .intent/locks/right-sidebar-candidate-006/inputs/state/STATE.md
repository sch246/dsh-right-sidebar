...
Status: draft embedded intent package with one selected C6 closure candidate over the C5 source realization. Retained C1 through C5 locks are historical implementation, installation and lifecycle evidence, not current package-wide acceptance.
