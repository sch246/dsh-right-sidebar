...
Status: draft embedded intent package with one selected C3 candidate realization. Retained C1 and C2 locks are historical implementation and lifecycle evidence, not current acceptance.
