...
.dsh-rightbar-collapse:focus-visible,.dsh-rightbar-tab:focus-visible,.dsh-rightbar-toggle:focus-visible,.dsh-rightbar-retry:focus-visible{outline:2px solid var(--dsw-alias-brand-primary,currentColor);outline-offset:2px;}
...
@container (max-width:260px){.dsh-rightbar-header{padding-right:12px}.dsh-rightbar-title{position:absolute;width:1px;height:1px;overflow:hidden;clip-path:inset(50%);white-space:nowrap}.dsh-rightbar-tab{padding-inline:8px}.dsh-rightbar-body{padding-inline:8px}}
@media (prefers-reduced-motion:no-preference){.dsh-rightbar-collapse,.dsh-rightbar-tab,.dsh-rightbar-toggle,.dsh-rightbar-retry{transition:background-color 120ms ease,color 120ms ease,border-color 120ms ease;}}
`
